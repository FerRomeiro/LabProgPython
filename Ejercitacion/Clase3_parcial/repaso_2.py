...
class Usuario: #LAS CLASES SON PLANTILLA DE UNA ENTIDAD 
    ...
    @property #SI NO PONDRIA PROPERTY NO ME IMPRIME, SOLO IMPRIME LA POSICION DE MEMORIA DEL PASSWORD. EL PROPERTY ES COMO UN INTERCEPTOR 
                ...
                #EL PROPERTY ES UN RECEPTOR Q CUANDO ESTEMOS TRABAJANDO CON EL OBJETO. EJ: USUARIO_UNO. EL PROPERTY VA A INTERCEDER Y LO VA A INTERPRETAR
                #DE UNA MANERA MAS FACIL PARA TRABAJAR Y ESO HACE Q NO TENGA Q PONER PARENTESIS 
    ...
    #ESTA ES UNA MANERA DE TRABAJAR LOS ATRIBUTOS PRIVADOS Y ESTA ADENTRO DE LA CLASS USUARIO, Y DENTRO DE LA CLASE USUARIO PUEDO ACCEDER A MIS ATRIBUTOS
    #PRIVADOS SI YO QUISIERA HACERLO DESDE AFUERA DE CLASS USUARIO ES IMPOSIBLE
